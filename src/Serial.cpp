...
// General commands
  ...
  {"GNAME", CMDstr, 0, (char *)rfgendata.Name},                           // Report system name
  {"SNAME", CMDstr, 1, (char *)rfgendata.Name},                           // Set system name
...
// SPI flash file IO function
  ...
  {"LOADCAL", CMDfunction, 0, (char *)loadCalibrations},                   // Load current calibration from flash FS
// RF gen commands
  {"TUNE",  CMDbool, 1, (char *)&TuneRequest},                            // Auto tune
  {"ISTUNE",CMDbool, 0, (char *)&Tuning},                                 // Returns TRUE if system is tuning
  {"SMAXTF",CMDint, 1, (char *)&MaxTuneFreq},                             // Sets the maximum tune frequency in Hz
  {"GMAXTF",CMDint, 0, (char *)&MaxTuneFreq},                             // Returns the maximum tune frequency in Hz
  {"SMINTF",CMDint, 1, (char *)&MinTuneFreq},                             // Sets the minimum tune frequency in Hz
  {"GMINTF",CMDint, 0, (char *)&MinTuneFreq},                             // Returns the minimum tune frequency in Hz
  {"SENA",  CMDbool, 1, (char *)&rfgendata.Enable},                       // RF head enable command, TRUE to enable
  {"GENA",  CMDbool, 0, (char *)&rfgendata.Enable},                       // Returns the enable status
  {"RADC",  CMDfunction, 1, (char *)ReadADC},                             // Read the selected ADC channel
  {"SFREQ", CMDint, 1, (char *)&rfgendata.Freq},                          // Sets frequency 
  {"GFREQ", CMDint, 0, (char *)&rfgendata.Freq},                          // Returns frequency 
  {"SDRV", CMDfloat, 1, (char *)&rfgendata.Drive},                        // Sets drive 
  {"GDRV", CMDfloat, 0, (char *)&rfgendata.Drive},                        // Returns drive 
  {"SRFV", CMDfloat, 1, (char *)&rfgendata.Setpoint},                     // Sets RF voltage setpoint 
  {"GRFV", CMDfloat, 0, (char *)&rfgendata.Setpoint},                     // Returns RF voltage setpoint
  ...
  {"SGAIN", CMDfloat, 1, (char *)&rfgendata.Gain},                        // Sets closed loop gain
  {"GGAIN", CMDfloat, 0, (char *)&rfgendata.Gain},                        // Returns closed loop gain
  {"SMODE", CMDbool, 1, (char *)&rfgendata.Mode},                         // Sets mode, TRUE = closed loop mode, FALSE = open loop
  {"GMODE", CMDbool, 0, (char *)&rfgendata.Mode},                         // Returns mode
  {"SMDRV", CMDfloat, 1, (char *)&rfgendata.MaxDrive},                    // Sets max drive level
  {"GMDRV", CMDfloat, 0, (char *)&rfgendata.MaxDrive},                    // Returns max drive level
  {"SMPWR", CMDfloat, 1, (char *)&rfgendata.MaxPower},                    // Sets max power level
  {"GMPWR", CMDfloat, 0, (char *)&rfgendata.MaxPower},                    // Returns max power level
  {"SRLY", CMDfunctionStr, 2, (char *)SetRelay},                          // Sets the relay state. Relay, 1,2,3, state OPEN or CLOSE
  {"GRLY", CMDfunction, 1, (char *)GetRelay},                             // Returns the relay state. Relay, 1,2,3, state OPEN or CLOSE
  {"SBIAS", CMDfunctionStr, 1, (char *)SetBias},                          // Sets the bias voltage
  {"GBIAS", CMDfloat, 0, (char *)&rfgendata.Bias},                        // Returns the bias voltage
#ifdef RFGEN2
// Ramp generation commands, rev 2 hardware with fast ramping
  {"SRPSV", CMDfunctionStr, 1, (char *)setRampStartV},                    // Ramp start bias voltage, float
  {"GRPSV", CMDfloat, 0, (char *)&rfgendata.rampStartV},
  {"SRPEV", CMDfunctionStr, 1, (char *)setRampEndV},                      // Ramp end bias voltage, float
  {"GRPEV", CMDfloat, 0, (char *)&rfgendata.rampEndV},
  {"SRPTM", CMDfunctionStr, 1, (char *)setRampTime},                      // Ramp time in mS, float
  {"GRPTM", CMDfloat, 0, (char *)&rfgendata.rampTime},
  {"STRP", CMDfunction, 0, (char *)setRampStart},                         // Ramp start
  {"SRPTRG", CMDfunctionStr, 1, (char *)setRampTrigger},                  // Ramp trigger, OFF | ACTIVE | INACTIVE
  {"GRPTRG", CMDfunction, 0, (char *)getRampTrigger},           

  {"SRPCT", CMDfunctionStr, 1, (char *)setRampChangePoint},               // Ramp time point in mS where a ramp rate change will occure
  {"GRPCT", CMDfloat, 0, (char *)&rfgendata.changePoint},
  {"SRPRM", CMDfunctionStr, 1, (char *)setRampMult},                      // Ramp rate multiplier after the change point
  {"GRPRM", CMDfloat, 0, (char *)&rfgendata.rampMult},
#endif
// Hardware trigger input
  {"STRIG", CMDfunctionStr, 1, (char *)setTrigger},                       // Trigger, OFF | GATE
  {"GTRIG", CMDfunction, 0, (char *)getTrigger},
  {"STRGL", CMDfunctionStr, 1, (char *)setTriggerLevel},                  // Trigger active level, HIGH | LOW
  {"GTRGL", CMDfunction, 0, (char *)getTriggerLevel},
// Misc controls
  {"SGATE", CMDbool, 1, (char *)&rfgendata.Gate},                          // Gate, TRUE | FALSE
  {"GGATE", CMDbool, 0, (char *)&rfgendata.Gate},
  {"USEDMA", CMDfunction, 0, (char *)useDMA},                             // Output bias voltage using DMA
// Calibration function
  {"CALBIAS", CMDfunction, 0, (char *)calBias},                           // Calibrate bias DC supply
  {"CALRFL", CMDfunctionStr, 1, (char *)genPWLcalTable},                  // Calibrate RF level table, RF+ or RF-
